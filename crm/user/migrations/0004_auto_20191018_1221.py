# -*- coding: utf-8 -*-
# Generated by Django 1.11.24 on 2019-10-18 12:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('campuses', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Campuses', verbose_name='校区')),
                ('teachers', models.ManyToManyField(to='user.UserInfo', verbose_name='老师')),
            ],
        ),
        migrations.CreateModel(
            name='ConsultRecord',
            fields=[
                ...
                ('consultant', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records', to='user.UserInfo', verbose_name='跟进人')),
            ],
        ),
        migrations.CreateModel(
            name='CourseRecord',
            fields=[
                ...
                ('re_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.ClassList', verbose_name='班级')),
                ('teacher', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.UserInfo', verbose_name='讲师')),
            ],
        ),
        migrations.CreateModel(
            name='Customer',
            fields=[
                ...
                ('class_list', models.ManyToManyField(blank=True, to='user.ClassList', verbose_name='已报班级')),
                ('consultant', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='customers', to='user.UserInfo', verbose_name='销售')),
                ('introduce_from', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='user.Customer', verbose_name='转介绍自学员')),
            ],
            options={
                'verbose_name': '客户信息表',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delete_status', models.BooleanField(default=False, verbose_name='删除状态')),
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Customer', verbose_name='客户名称')),
                ('enrolment_class', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.ClassList', verbose_name='所报班级')),
                ('school', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Campuses')),
            ],
        ),
        migrations.CreateModel(
            name='StudyRecord',
            fields=[
                ...
                ('course_record', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.CourseRecord', verbose_name='某节课程')),
                ('student', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Customer', verbose_name='学员')),
            ],
        ),
        migrations.AddField(
            model_name='consultrecord',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='user.Customer', verbose_name='所咨询客户'),
        ),
        migrations.AddField(
            model_name='userinfo',
            name='depart',
